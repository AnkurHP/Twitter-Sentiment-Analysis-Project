...
{
  consumerKey="HcP5MUPAR5pIihWB8yZafnLJ0"
  consumerSecret="b4qoLZtDMVqMevByZJ7t9yPhiTR3AzdN36eHPkcnqaC6skiRRv"
  ...
  setup_twitter_oauth(consumerKey,consumerSecret,access_token="4023733011-cZcqVbMNSkBrA7g8bV7QBFsk8bHkyVd6kiRC8lh",access_secret="gArshF0JoR98bN2Fx9nM2LWqqXJXx2xVkjXpqQypMhg1y")
...
shinyServer(function(input, output) {
  ...
  pos.words=scan('C:/Users/Ankur Pansara/Desktop/positive-words.txt', what='character',comment.char=';')
  neg.words=scan('C:/Users/Ankur Pansara/Desktop/negative-words.txt', what='character',comment.char=';')
